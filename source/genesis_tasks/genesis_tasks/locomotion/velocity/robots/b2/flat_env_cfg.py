"""Configuration for Unitreeb2 velocity tracking task on flat terrain."""
...
class UnitreeB2FlatEnvCfg(UnitreeB2RoughEnvCfg):
    """Configuration for Unitreeb2 velocity tracking on flat terrain."""
...
class UnitreeB2FlatEnvCfg_PLAY(UnitreeB2FlatEnvCfg):
    """Configuration for Unitreeb2 velocity tracking on flat terrain (play mode)."""

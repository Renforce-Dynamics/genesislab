...
@configclass
class BoosterK1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Terminations
        self.terminations.base_height.params["asset_cfg"] = SceneEntityCfg("robot", body_names="torso_link")

"""Configuration for Boostert1 velocity tracking task on flat terrain."""
...
class BoosterT1FlatEnvCfg(BoosterT1RoughEnvCfg):
    """Configuration for Boostert1 velocity tracking on flat terrain."""
...
class BoosterT1FlatEnvCfg_PLAY(BoosterT1FlatEnvCfg):
    """Configuration for Boostert1 velocity tracking on flat terrain (play mode)."""

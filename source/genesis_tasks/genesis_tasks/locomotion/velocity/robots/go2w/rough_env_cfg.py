"""Configuration for Unitree Go2W velocity tracking task on rough terrain."""
...
from genesis_assets.robots import UNITREE_GO2W_CFG
import genesis_tasks.locomotion.velocity.mdp as mdp


@configclass
class UnitreeGo2WRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    """Configuration for Unitree Go2W velocity tracking on rough terrain."""
...
class UnitreeGo2WRoughEnvCfg_PLAY(UnitreeGo2WRoughEnvCfg):
    """Configuration for Unitree Go2W velocity tracking on rough terrain (play mode)."""

"""Configuration for Unitreego2W velocity tracking task on flat terrain."""
...
class UnitreeGo2WFlatEnvCfg(UnitreeGo2WRoughEnvCfg):
    """Configuration for Unitreego2W velocity tracking on flat terrain."""
...
class UnitreeGo2WFlatEnvCfg_PLAY(UnitreeGo2WFlatEnvCfg):
    """Configuration for Unitreego2W velocity tracking on flat terrain (play mode)."""
